        ...
        submitdata() {
            ...
            if(this.type == 'mobile'){
                ...
                if(zhdexdatabackground){
                    this.background.pc = zhdexdatabackground.pc;
                }else{
                ...
                if(zhdexdatabackground){
                    this.background.mobile = zhdexdatabackground.mobile;
                }else{
            ...
            setTimeout(() => {
                this.loading = false;
                this.setCookie('zhdexdatabackground', this.background,0.005);
                location.reload();
            }, 800)   
        },
        redefault(){              
            ...
            setTimeout(() => {
                this.loading = false;
                this.eraseCookie('zhdexdatabackground');
                location.reload();
            }, 800) 
        },
        cancel() {
...
.selectedStyle{
    border: 2px solid var(--zhdex-vcard-color);
    
    box-shadow: 0 0 10px rgba(25, 118, 210, 0.5),;
}

.selected-item {
  border-color: var(--zhdex-vcard-color); /* 选中时的边框颜色 */
  box-shadow: 0 0 10px var(--zhdex-vcard-color); /* 选中时的阴影 */
}
</style>