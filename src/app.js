...
export default {
  ...
  methods: {
    ...
    setMainProperty(imageurl){
      ...
      let zhdexdata = this.getCookie("zhdexdata");
      if(zhdexdata){
        root.style.setProperty('--zhdex-welcomtitle-color', `${zhdexdata.color.welcometitlecolor}`);
        root.style.setProperty('--zhdex-vcard-color', `${zhdexdata.color.themecolor}`);
        root.style.setProperty('--zhdex-brightness', `${zhdexdata.brightness}%`);
        root.style.setProperty('--zhdex-blur', `${zhdexdata.blur}px`); 
      }else{
        root.style.setProperty('--zhdex-welcomtitle-color', `${this.configdata.color.welcometitlecolor}`);
        root.style.setProperty('--zhdex-vcard-color', `${this.configdata.color.themecolor}`);  
        root.style.setProperty('--zhdex-brightness', `${this.configdata.brightness}%`);  
        root.style.setProperty('--zhdex-blur', `${this.configdata.blur}px`);
      }
  
      let zhdexdatabackground = this.getCookie("zhdexdatabackground");
      const { xs } = useDisplay();
      if(zhdexdatabackground){
        if(xs.value){
          if(zhdexdatabackground.mobile.type == "pic"){
            root.style.setProperty('--zhdex-background-image-url', `url('${zhdexdatabackground.mobile.datainfo.url}')`);
            imageurl = zhdexdatabackground.mobile.datainfo.url;
            return imageurl;
          }else{
            this.videosrc = zhdexdatabackground.mobile.datainfo.url;
          }
        }else{
          if(zhdexdatabackground.pc.type == "pic"){
            root.style.setProperty('--zhdex-background-image-url', `url('${zhdexdatabackground.pc.datainfo.url}')`);
            imageurl = zhdexdatabackground.pc.datainfo.url;
            return imageurl;
          }else{
            this.videosrc = zhdexdatabackground.pc.datainfo.url;
          }
        }
        ...
        if(xs.value){
          if(this.configdata.background.mobile.type == "pic"){
            root.style.setProperty('--zhdex-background-image-url', `url('${this.configdata.background.mobile.datainfo.url}')`);
          ...
          if(this.configdata.background.pc.type == "pic"){
            root.style.setProperty('--zhdex-background-image-url', `url('${this.configdata.background.pc.datainfo.url}')`);
